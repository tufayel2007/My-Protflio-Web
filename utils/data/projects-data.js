export const projectsData = [
  ...
  },
  {
    ...
    description:
      "This system is a digital platform where citizens can report public issues such as broken streetlights, potholes, water leakage, garbage overflow, and damaged sidewalks.Admins and government staff can quickly manage, verify, assign, and resolve citizen reports.Premium users get priority support and can post issues for 50৳ with direct admin access.",
    tools: ["React", "MongoDB", "HTML", "CSS", "Javascript", "Tailwind"],
    role: "Full Stack Developer",
    code: "https://github.com/tufayel2007/Public-Infrastructure-Issue-Reporting-System-Frontend.git",
    demo: "https://issue-hub-nine.vercel.app/",
    image: "/NagorSeba.png",
  },
  {
    id: 3,
